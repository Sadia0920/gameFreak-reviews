...
export default function PlayStationGameDetails() {
  return (
    ...
    <br/>
    <br/>
    <span className=' text-xl font-bold text-gray-900'>1. Popular Game Genres on PlayStation</span>
    <br/>
    ...
    <br/>
    <br/>
    <span className=' text-xl font-bold text-gray-900'>2. Popular PlayStation Games</span>
    <br/>
    <span className=' text-lg font-bold text-gray-900'>Action-Adventure Games</span>
    <br/>
    ...
    <br/>
    <span className=' text-lg font-bold text-gray-900'>Role-Playing Games (RPGs)</span>
    <br/>
    ...
    <br/>
    <span className=' text-lg font-bold text-gray-900'>Platformers</span>
    <br/>
