...
export default function PremiumAccess() {
  return (
    <div className="w-10/12 mx-auto my-14">
        <h1 className="text-3xl font-bold text-center mb-9 w-10/12 lg:w-6/12 mx-auto">Unlock Exclusive Content with Premium Access</h1>
        <div
  ...
  <div className="hero-content text-neutral-content text-center">
    <div className="">
      <h1 className="mb-5 text-3xl md:4xl lg:text-5xl font-bold">Premium Access</h1>
...
<div className="card bg-base-100 image-full shadow-xl">
  ...
  <div className="card-body">
    <h2 className="text-lg md:text-xl font-bold">Members-Only Discord Access</h2>
    <p className='w-52 mx-auto md:w-80'>It provides a space for the gaming community to interact, share insights, and discuss various gaming topics, all within a more intimate and private setting.</p>
    <div className="card-actions justify-end">
